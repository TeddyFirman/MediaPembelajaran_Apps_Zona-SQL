...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getSelectedTopicName = getIntent().getStringExtra("Menu terpilih");
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedOptionByUser.isEmpty()) {
                    Toast.makeText(QuizActivity.this, "Mohon Pilih Jawaban!", Toast.LENGTH_SHORT).show();
                }
                else{
                    changeNextQuestion();
                }
    ...
    private void changeNextQuestion() {
        ...
        if(currentQuestionPosition < questionsLists.size()){
            ...
            option1.setBackgroundResource(R.drawable.round_back_white_stroke_2_10);
            option1.setTextColor(Color.parseColor("#1F6BB8"));

            option2.setBackgroundResource(R.drawable.round_back_white_stroke_2_10);
            option2.setTextColor(Color.parseColor("#1F6BB8"));

            option3.setBackgroundResource(R.drawable.round_back_white_stroke_2_10);
            option3.setTextColor(Color.parseColor("#1F6BB8"));

            option4.setBackgroundResource(R.drawable.round_back_white_stroke_2_10);
            ...
            intent.putExtra("Benar", getCorrectAnswer());
            intent.putExtra("Salah", getIncorrectAnswer());
